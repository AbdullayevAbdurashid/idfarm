  ...
  const handleFilter = (e) => {
    ...
    if (value.length) {
      updatedData = cowData.filter((item) => {
        const startsWith = item.id
          .toLowerCase()
          .startsWith(value.toLowerCase());
        const includes = item.id.toLowerCase().includes(value.toLowerCase());
      ...
      <Card>
            ...
            <UncontrolledButtonDropdown>
              ...
              <DropdownMenu>
                <DropdownItem className="w-100">
                  <Printer size={15} />
                  <span className="align-middle ms-50">Chiqarish</span>
                </DropdownItem>
                <DropdownItem
                  className="w-100"
                ...
                <DropdownItem className="w-100">
                  <Copy size={15} />
                  <span className="align-middle ms-50">Copiya</span>
                </DropdownItem>
              </DropdownMenu>
            </UncontrolledButtonDropdown>
        ...
        <div className="react-dataTable react-dataTable-selectable-rows">
          <DataTable
            ...
            data={searchValue.length ? filteredData : cowData}
          />
        </div>
      </Card>

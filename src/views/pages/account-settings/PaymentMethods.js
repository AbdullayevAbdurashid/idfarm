    ...
    <Fragment>
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">Tolov turlari</CardTitle>
        </CardHeader>
                      ...
                      <div className="d-flex justify-content-between flex-sm-row flex-column">
                        ...
                        <div className="d-flex flex-column text-start text-lg-end">
                          <div className="d-flex order-sm-0 order-1 mt-1 mt-sm-0">
                            ...
                            <Button outline>Ochirib yuborish</Button>
                          </div>
                          <span className="mt-2">
                            Kara {card.expiryDate} kuni tugaydi
                          </span>
                        </div>
                      </div>
                    </div>

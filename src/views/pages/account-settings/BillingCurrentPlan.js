    ...
    <Fragment>
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">Joriy Obuna</CardTitle>
        </CardHeader>
          ...
          <Row>
            <Col md="6">
              <div className="mb-2 pb-50">
                <h5>
                  Sizning joriy obunangiz <strong>Odd</strong>
                </h5>
                <span>A simple start for everyone</span>
              </div>
              <div className="mb-2 pb-50">
                <h5> Muddati : 9 dekabr</h5>
                <span>
                  Obuna muddati tugashi bilan sizga bildirishnoma yuboramiz
                </span>
              </div>
              <div className="mb-2 mb-md-1">
                ...
                <span>Kichik va o'rta ferma uchun standart OBUNA</span>
              </div>
            </Col>
            <Col md="6">
              <div className="plan-statistics pt-1">
                <div className="d-flex justify-content-between">
                  <h5 className="fw-bolder">Kunlar</h5>
                  <h5 className="fw-bolder">26 kun qoldi</h5>
                </div>
                <Progress className="mb-50" value={75} />
                <p className="mt-50"> Tarif tugashiga 26 kun qoldi</p>
              </div>
            </Col>
            <Col xs={12}>
              <Button
